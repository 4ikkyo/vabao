...
! function() {
    ...
    var rt = function(t, n) {
        ...
        lt = function(t, n, e) {
            ...
            function d(n) { return y('<button class="' + s.arrow + " " + (n ? s.prev : s.next) + '" type="button"><img src="img/svg/slide.svg"><path d="' + (t.options.arrowPath || "m15.5 0.932-4.3 4.38 14.5 14.6-14.5 14.5 4.3 4.4 14.6-14.6 4.4-4.3-4.4-4.4-14.6-14.6z") + '" />') }
            return {
