...
class FileManager {
  ...
  constructor(containerElement) {
    ...
    this._fakeInput = this._containerElement.querySelector(
      "[js-fake-file-input]"
    );
    this._realInput = this._containerElement.querySelector(
      "[js-real-file-input]"
    );
    this._chipContainer = this._containerElement.querySelector(
      "[js-chip-container]"
    );
    this._noFile = this._containerElement.querySelector("[js-no-file]");
    this._removeFilesButton =
      this._containerElement.querySelector("[js-remove-files]");
  ...
  _addEventListeners = () => {
    this._fakeInput.addEventListener(
      "click",
      this._handleFakeInputClick,
      false
    );
    this._realInput.addEventListener(
      "change",
      this._handleRealInputChange,
      false
    );
    this._removeFilesButton.addEventListener(
      "click",
      this._handleRemoveFilesButtonClick,
      false
    );
  };
